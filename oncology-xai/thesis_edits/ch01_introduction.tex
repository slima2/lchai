...
meaningful explanations---in the form of spatially grounded attention
maps and histological pattern attributions---that a pathologist can
verify against the original slide, and do SHAP decompositions
quantify the relative contribution of visual embeddings versus
explicit pattern knowledge?}
...
\begin{enumerate}
    ...
    \item \textbf{LCHAI~v2.0 clinical prototype:} An integrated clinical decision-support system that combines tile-level pattern classification, attention-based mutation prediction with gene-dependent optimal method selection, SHAP decomposition, Choquet Shapley values, LLM-generated explanations, and knowledge-graph reasoning, demonstrating the translational potential of the proposed artefacts.
\end{enumerate}
