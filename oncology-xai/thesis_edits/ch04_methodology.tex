...
PI-ABMIL  & PI-ABMIL (concat soft, ours) & $\mathbf{h}_i = [\mathbf{x}_i \,\|\, \mathbf{p}_i]$ & 518 \\
...
For conditions B2, B3, PI-ABMIL, and A, the ABMIL architecture consists of three modules: a tile-level transformation, an attention mechanism, and a slide-level classifier.
...
\begin{enumerate}
    ...
    (PI-ABMIL), operating on the full 518-d representation
