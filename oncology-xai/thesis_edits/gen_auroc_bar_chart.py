...
data = {
    ...
    "Concat (ours)":  {"TP53": (.717,.058), "EGFR": (.694,.051), "KRAS": (.590,.071), "STK11": (.695,.023), "KEAP1": (.610,.071), "RBM10": (.640,.064)},
    "Abl: one-hot":   {"TP53": (.716,.050), "EGFR": (.695,.046), "KRAS": (.594,.071), "STK11": (.691,.050), "KEAP1": (.594,.082), "RBM10": (.623,.048)},
    "Fuzzy Choquet":  {"TP53": (.716,.047), "EGFR": (.684,.037), "KRAS": (.609,.059), "STK11": (.658,.077), "KEAP1": (.589,.080), "RBM10": (.661,.063)},
}
