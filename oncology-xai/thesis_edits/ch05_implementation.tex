...
PI-ABMIL dim.       & Total input (condition PI-ABMIL, ours)  & 518 \\
...
representations; the primary experimental baseline is B2
(Section~\ref{sec:meth:mutation:representations}), against which all
pattern-informed methods are compared.
...
figure generators are archived in the \texttt{Thesis/} directory of
the public repository, enabling independent verification of every
table and figure in Chapter~\ref{ch:evaluation}.
