...
The ANORAK class mapping was corrected on 4 April 2026 using the
official Zenodo documentation (Section~\ref{sec:uc:zenodo}); the
corrected overlay index and generation script are included in the
repository.
