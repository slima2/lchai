...
The input dimension varies by condition: 512 (B2), 6 (B3), 518 (PI and A).
...
\begin{enumerate}
    ...
    $c \in \{B1, B2, B3, \text{PI}, A, \text{FC}\}$ (6 conditions).
    ...
    \begin{enumerate}
        ...
        \item For conditions B2, B3, PI, A: train an ABMIL model for
        50 epochs.
...
\caption[LCHAI~v2.0 Admin --- System Parameters]{%
    ...
    thresholds, prediction method selection (B2/PI/FC), and inference parameters
