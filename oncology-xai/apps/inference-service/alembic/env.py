"""Alembic environment configuration for inference-service."""
...
db_url = os.getenv("POSTGRES_DSN_SYNC", os.getenv("POSTGRES_DSN", config.get_main_option("sqlalchemy.url")))
