"""EHR Service — FastAPI application."""
...
app = FastAPI(title="LCHAI EHR Service", description="EHR ingestion, NER, ontology mapping", version=settings.version, lifespan=lifespan)
